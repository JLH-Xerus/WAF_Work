...
If @ToteId Is Null
   ...
   Select @ToteId = ToteId From CvyToteAtManFillStation With (NoLock) Where StationId = @StationId
...
Where
   ...
   And
   ((@BatchFillId Is Not Null And B.BatchFillId = @BatchFillId) Or @BatchFillId Is Null)
   And
