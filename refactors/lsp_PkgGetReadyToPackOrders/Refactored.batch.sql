-- Test batch generated from refactors/lsp_PkgGetReadyToPackOrders/Refactored.sql
...
DECLARE @CompleteOrdersOnly TinyInt = 1;
DECLARE @IgnorePendingAndProblemRxsWhenListingCompleteOrders TinyInt = 0;
DECLARE @RouteStop VarChar(8) = NULL;  -- TODO: supply test value
DECLARE @PartialShipmentsTimeoutMins Integer = NULL;  -- TODO: supply test value
DECLARE @OverridePoNum VarChar(30) = '';
DECLARE @DisplayRxsStoredInBinsAtAnyStation TinyInt = 0;
DECLARE @DisplayCompleteOrderStored TinyInt = 0;
