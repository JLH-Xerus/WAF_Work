-- Test batch generated from refactors/lsp_RxfGetListOfManualFillGroups/Refactored.sql
...
DECLARE @UseStockLocations Bit = NULL;  -- TODO: supply test value
DECLARE @FilteredLocationsOnly Bit = NULL;  -- TODO: supply test value
DECLARE @FillType varchar(1) = NULL;  -- TODO: supply test value
DECLARE @RetrieveTopXGroups Int = NULL;  -- TODO: supply test value
DECLARE @ToteId VarChar(24) = NULL;
DECLARE @GroupByStartingTotePopWorkflowStepCode Bit = NULL;  -- TODO: supply test value
DECLARE @UseHubGroupFilter Bit = NULL;  -- TODO: supply test value
DECLARE @HubNames VarChar(1000) = NULL;  -- TODO: supply test value
DECLARE @BatchFillId Int = Null;
DECLARE @SortByColumn VarChar(30) = NULL;  -- TODO: supply test value
DECLARE @AscendingSort bit = 1;
