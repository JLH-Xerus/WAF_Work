-- Test batch generated from refactors/lsp_RxvGetRxsQueuedForVerification/Refactored.sql
...
DECLARE @FillTypeFilter dbo.udtTableOfVarChars;  -- TVP: populate via INSERT below before running
DECLARE @LocationFilter dbo.udtTableOfVarChars;  -- TVP: populate via INSERT below before running

-- TVP seed inserts (TODO: populate with realistic test values)
-- INSERT INTO @FillTypeFilter (Value) VALUES (N'TODO');  -- TODO: supply real test values
-- INSERT INTO @LocationFilter (Value) VALUES (N'TODO');  -- TODO: supply real test values
